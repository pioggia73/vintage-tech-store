    ...
    const response = await props.stripe
     ...
     if(token) {
       ...
       let order = await submitOrder({
         name: name, total: total, items: cart, stripeTokenId: id, userToken: user.token})
  ...
  return  <section className="section form">
            ...
            <form className="checkout-form">
              ...
              <div className="stripe-input">
                <label htmlFor="card-elemnt">Credit or debit cart</label>
                <p className="stripe-info">
                  Test using this credit card: <span>4242 4242 4242 4242</span>
                  <br />
                  Enter any five digit for the zip code
                  <br />
                  Enter any three digits for CVV
                </p>
              </div>
              {/* end of cart element */}
              { /* STRIPE ELEMENTS */ }
...
const StripeWrapper = () => {
  ...
  return <StripeProvider 
            apiKey="pk_test_5NOC7Ch4ON5b3rEy49qihe1400VYIql7IN">
            <Elements>
              <CardForm>
